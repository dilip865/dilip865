...
- Worked with Excel, SQL, Python, and R  
...
- Developed voting system with role-based access  
- Created admin dashboard for results  

**Smart Pet Feeder**  
- Built automated feeder using ESP32  
- Controlled system using mobile app  
...
GitHub: https://github.com/dilip865  
LinkedIn: https://linkedin.com/in/dilip-kumar-o0/  
